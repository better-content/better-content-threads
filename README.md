...
Twelve illustrated loading briefs teach spoiler-free mental models. The first introduces Threads; later briefs rotate without repeats. A selected brief appears during the actual connection/load screen and remains as a paused post-arrival plate until Continue, Enter, or Space dismisses it. Escape is ignored, disconnects do not consume a brief, and dimension transitions do not create new episodes.
