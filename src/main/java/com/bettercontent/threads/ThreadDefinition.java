...
public record ThreadDefinition(String id,String title,ThreadSuit suit,int order,ThreadAspect aspect,ResourceLocation art,
    ...
    public ThreadDefinition{
        ...
        else{bounded(prose,MAX_TEXT,"prose");bounded(invitation,160,"invitation");bounded(action,192,"action");if(revealRoutes.isEmpty()||completionRoutes.isEmpty())throw new IllegalArgumentException("live thread lacks routes");}
    }
